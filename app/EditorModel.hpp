...
public:
    ...
    // Option 3 specifies the movement of the cursor one column to the left.
    // Option 4 specifies the movement of the cursor one column to the right.
...
private:
    ...
    // The text that currently exists in the text editor.
